...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>It is above all the uncompromising, performance-oriented aesthetic that unmistakeably reveals its ambitions.</p>
    </div>
    <div class="row">
      ...
      <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="resentnewcar">
          <?php 
          $sql = "SELECT tblvehicles.VehiclesTitle, tblbrands.BrandName, tblvehicles.PricePerDay, tblvehicles.dynamic_price, tblvehicles.FuelType, tblvehicles.ModelYear, tblvehicles.id, tblvehicles.SeatingCapacity, tblvehicles.VehiclesOverview, tblvehicles.Vimage1 
                  FROM tblvehicles 
          ...
          <div class="col-list-3">
            <div class="recent-car-list">
              ...
              <div class="car-title-m">
                ...
                <span class="price">
                  Nrs<?php echo !empty($result->dynamic_price) ? htmlentities($result->dynamic_price) : htmlentities($result->PricePerDay); ?> /Day
                </span>
              </div>
...
<!-- Login/Registration/Password Modals -->
