...
<html lang="en">
<head>
<!-- ... your HEAD code remains the same ... -->
...
$query->execute();
$vehicleCount = $query->rowCount();
?>
<p><span><?php echo htmlentities($vehicleCount); ?> Listings</span></p>
</div>
</div>

<?php 
// Main query to fetch car listings
...
?>
  <div class="product-listing-m gray-bg">
    ...
    <div class="product-listing-content">
      ...
      <p class="list-price">
        Nrs<?php echo !empty($result->dynamic_price) ? htmlentities($result->dynamic_price) : htmlentities($result->PricePerDay); ?> Per Day
      </p>
      <ul>
